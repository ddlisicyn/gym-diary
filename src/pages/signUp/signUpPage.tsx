...
export const SignUpPage = () => {
  ...
  return (
    <div className="flex flex-col w-screen h-screen justify-center items-center">
      ...
      <input
        type="email"
        className="mt-5 w-4/5 py-1.5 px-2.5 border border-gray-300 rounded-lg focus:outline-primary"
      ...
      />
      <button
        className="w-4/5 mt-4 bg-primary p-2.5 text-white rounded-lg font-semibold text-sm"
